		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(sid==null||sid.trim().equals("")){
					JOptionPane.showMessageDialog(SearchBooks.this,"Id can't be blank");
				}else{
					int id=Integer.parseInt(sid);
					int i=LibrarianDao.Search(id);
					if(i>0){
						JOptionPane.showMessageDialog(SearchBooks.this,"Record deleted successfully!");
					}else{
						JOptionPane.showMessageDialog(SearchBooks.this,"Unable to delete given id!");
					}
				}
			}
		});
